...
def Init():
    ...
    SetLEDColor(0, led.COLOR_PINK, led.MODE_PULSE, led.PULSE_SPEED_MEDIUM)
    SetLEDColor(1, led.COLOR_PINK, led.MODE_PULSE, led.PULSE_SPEED_MEDIUM, 1, OnInitContinue, 2)
